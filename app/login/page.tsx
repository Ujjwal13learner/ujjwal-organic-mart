...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Ujjwal Organic Mart mein aapka swagat hai! Login successfully.`);
  };

  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#f0fdf4', fontFamily: 'sans-serif' }}>
      <form onSubmit={handleLogin} style={{ backgroundColor: 'white', padding: '30px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', width: '300px' }}>
        <h2 style={{ color: '#16a34a', marginBottom: '20px', textAlign: 'center' }}>Customer Login</h2>
